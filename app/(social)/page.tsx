        ...
        >
          <div className="mt-5">
            <p className="text-[#334155] font-semibold text-[12px]">
              <span className="font-normal">replied to the topic</span> Welcome
              to the CoursePlayersGroup Forum in the Forum of CoursePlayers
              Group
            </p>

            <p className="text-[#64748B] text-[13px] mt-2">Yesterday</p>

            <p className="text-[#334155] mt-4 text-[16px]">Hello Everyone!</p>
          </div>
        </PostCard>
